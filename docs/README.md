...
<div align="center">
  ...
  <a href="quick-start.md"><img src="https://img.shields.io/badge/docs-quick%20start-6C63FF.svg?style=for-the-badge" alt="Quick start docs"></a>
</div>
...
<p align="center">
  ...
  <a href="mcp-tools.md">Tool Catalog</a> ·
  <a href="cli-reference.md">CLI Reference</a> ·
  <a href="best-practices.md">Best Practices</a>
</p>
...
📚 **[Read the full docs](doc-hub.md)** for architecture, walkthroughs, and playbooks.

### Quick Reference

- [Quick Start](quick-start.md) – cloned install + first run checklist
- [Configuration Guide](configuration.md) – infrastructure profiles, authentication, LLM routing
- [CLI Reference](cli-reference.md) – every `mcp` subcommand
- [Tool Catalog](mcp-tools.md) – MCP scopes, schemas, and safety tips
- [Autopilot Playbooks](autopilot.md) – incident and runbook examples
- [Best Practices](best-practices.md) – budgeting, safety rails, audit patterns
- [Product Requirements](product-requirements.md) – roadmap and north-star features
...
Populate the file with the SSH servers, Kubernetes clusters, and Docker hosts you want Orbit to manage, then add any LLM credentials (`OPENAI_API_KEY`, `ANTHROPIC_API_KEY`, etc.) as environment variables or directly under the `llm.providers` section. See [configuration.md](configuration.md) for every field.
...
A hands-on flow for Claude Code lives in the MCP section of [quick-start.md](quick-start.md).
...
More scenarios and fixes live in [best-practices.md](best-practices.md) and [autopilot.md](autopilot.md).
